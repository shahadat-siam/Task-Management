  ...
  return (
    <nav className="bg-[#55AD9B] px-12 py-5">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div>
          <Link to="/" className="text-white text-4xl font-bold">Task MNG</Link>
        </div>
          ...
          {user ? (
            <>
              <div className="relative">
                <button onClick={handleMenuToggle} className="text-white flex items-center">
        ...
        <div className="md:hidden bg-[#51a393] py-2">
          ...
          {user ? (
            <>
              ...
              <button onClick={handleLogout} className="block px-4 py-2 text-white w-full text-left">Logout</button>
            </>
          ) : (
            <>
              <Link to="/login" className="block px-4 py-2 text-white">Login</Link>
              <Link to="/signup" className="block px-4 py-2 text-white">Register</Link>
            </>
          )}
        </div>
      )}
